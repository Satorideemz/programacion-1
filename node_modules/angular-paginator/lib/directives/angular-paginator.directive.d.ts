...
export declare class AngularPaginatorDirective implements OnInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<AngularPaginatorDirective, "angularPaginator, [angularPaginator]", ["angularPaginator"], { "id": { "alias": "id"; "required": false; }; "maxSize": { "alias": "maxSize"; "required": false; }; "rotate": { "alias": "rotate"; "required": false; }; "boundaryLinkNumbers": { "alias": "boundaryLinkNumbers"; "required": false; }; "forceEllipses": { "alias": "forceEllipses"; "required": false; }; }, { "pageChange": "pageChange"; }, never, never, false, never>;
}
