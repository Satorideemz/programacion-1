...
@Component({
  selector: 'app-abm-admi',
  templateUrl: './abm-admi.component.html',
  styleUrls: ['./abm-admi.component.css']
})
export class AbmAdmiComponent {
  ...
  handleButtonClick(): void {
    ...
    this.router.navigate(['/editar-rutina-admi']); // Replace 'your-desired-route' with the actual route you want to navigate to
    }
